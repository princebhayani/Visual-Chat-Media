...
const UserListDialog = () => {
	...
	const handleCreateConversation = async () => {
		...
		try {
			...
			// Update a global state called "selectedConversation"
	...
	return (
		<Dialog>
			...
			<DialogContent>
				...
				{/* TODO: input file */}
				<input type="file" accept="image/*" ref={imgRef} onChange={(e)=>setSelectedImage(e.target.files![0])} placeholder="select image" hidden/>
